...
| `#/places/directory` | Справочник СТО выбранного города (Ростов-на-Дону ~1 000, Евпатория ~160 автосервисов и шиномонтажей из Яндекс Карт, `domain/directory/<город>.json`, грузится отдельным куском): поиск по названию и улице, вид «Все · СТО · Шины», карточка — адрес (ссылка на организацию в Яндекс Картах), телефоны, «Добавить в мои места». Город — на устройстве (localStorage), выбирается здесь и в настройках; не выбран — справочника нигде нет. Поле «Место» у ТО и шиномонтажа с двух букв подсказывает до 8 мест справочника («название, адрес · Яндекс Карты»), уже свои — нет; выбор заводит своё место с адресом, первым телефоном и ссылкой |
