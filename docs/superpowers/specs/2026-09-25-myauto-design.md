...
влево, линии красятся токенами темы (`--schematic-*`, маска `mask-image`). Сейчас чертежи есть для Skoda Octavia A5
(2004–2013, не универсал, не Tour) и Kia cee'd первого поколения (2006–2012, универсал); год и кузов проверяются,
только если указаны. Остальные машины — карточка как раньше.
...
- **Зоны.** Двигатель (масло, фильтры, свечи, ГУР), ГРМ и ремни (ремень/цепь, приводной ремень, помпа) — дальний
  ...
  диски). Свои узлы — по группе каталога; кузов и «Прочее» на чертеже не отмечаются.
