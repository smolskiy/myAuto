  ...
  expect(
    masterSpend(
      service({
        ...
        total: 12000,
        works: [
          { id: 'w1', name: 'Замена', price: 5000, masterId: M },
...
test('сводка визитов', () => {
  const recs = [
    service({ date: '2026-02-01', placeId: P, total: 10000 }),
    service({ date: '2026-03-01', placeId: P, total: 5001 }),
    service({ date: '2026-04-01', total: 7 }),
  ]
  expect(visitStats(recs, (r) => placeSpend(r, P))).toEqual({
    visits: 2,
    total: 15001,
    average: 7501,
    lastDate: '2026-03-01',
